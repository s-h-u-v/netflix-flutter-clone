...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _onSearchChanged(String query) {
    ...
    final allMovies = [...provider.trendingMovies, ...provider.topRatedMovies, ...provider.popularMovies];
        ...
        return ListTile(
          ...
          leading: SizedBox(
            ...
            child: movie.posterPath.isNotEmpty
                ...
                : Container(color: Colors.grey[800], child: const Icon(Icons.movie, color: Colors.grey)),
          ),
          title: Text(movie.title, style: const TextStyle(color: Colors.white)),
          trailing: const Icon(Icons.play_circle_outline, color: Colors.white, size: 30),
          onTap: () {
            Navigator.push(
              context,
